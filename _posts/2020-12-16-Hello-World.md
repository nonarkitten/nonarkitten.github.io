...
**PJIT** is the runtime for the Buffy Acellerator and provides 68000 emulation. It is a threaded JIT which can approach 1000 MIPS of perormanc or roughly equivalent to a 1200MHz 68040 (hence the PR1200 moniker on the Buffy). However, to play it safe (since not all features are implemented yet), I'm only promising 400MHz performance or better.
